...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="sqlDataSourcesContainer">
        ...
        SelectCommand="select * from [TeamProject].[dbo].[table_example]">
        </asp:SqlDataSource>
    </div>

    <asp:GridView runat="server" ID="FirstGridView" DataSourceID="FirstGridViewSqlDataSource" CssClass="gridview-one" AutoGenerateColumns="false">
        <Columns>
